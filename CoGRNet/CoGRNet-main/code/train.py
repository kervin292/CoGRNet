...
from utils.CoGRNet_utils import context_mask, mix_loss, update_ema_variables, adjust_roi_parameters,compute_roi_parameters,apply_updated_roi_parameters


parser = argparse.ArgumentParser()
parser.add_argument('--root_path', type=str, default="../data/LA", help='Name of Dataset')
parser.add_argument('--exp', type=str,  default='CoGRNet', help='exp_name')
...
if __name__ == "__main__":
    ...
    pre_snapshot_path = "./predict/CoGRNet/LA_{}_{}_labeled/pre_train/best_model.pth".format(args.exp, args.labelnum)
    self_snapshot_path = "./predict/CoGRNet/LA_{}_{}_labeled/self_train/best_model.pth".format(args.exp, args.labelnum)

    print("Starting CoGRNet training.")
